...
export const Footer: React.FC = () => {
  return (
    <footer className="bg-landing-accent text-landing-muted py-16 px-6 md:px-12 border-t border-landing-border">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
        <div className="md:col-span-1">
          <Link to="/" className="flex items-center space-x-2 mb-6">
            ...
            <span className="font-bold text-xl tracking-tight text-white">TrustNet AI</span>
          </Link>
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm">
            ...
            <li><Link to="/console" className="hover:text-white transition-colors">Console Demo</Link></li>
            <li><a href="http://localhost:8000/docs" className="hover:text-white transition-colors">Documentation</a></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <div className="flex space-x-4">
            <a href="#" className="bg-landing-surface p-2 rounded-full hover:bg-landing-card transition-colors text-white">
