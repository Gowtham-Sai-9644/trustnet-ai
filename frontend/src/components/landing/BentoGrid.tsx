  ...
  return (
    <section className="py-24 px-6 md:px-12 bg-transparent" id="features">
      <div className="max-w-7xl mx-auto">
        <motion.h2  className="text-3xl md:text-5xl font-bold text-landing-text tracking-tight mb-16 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[280px]">
          ...
          <motion.div   
            whileHover={{ y: -5 }}
            className="md:col-span-2 bg-landing-card border border-landing-border backdrop-blur-md rounded-3xl p-8 border border-landing-border shadow-[0_4px_20px_rgb(0,0,0,0.03)] relative overflow-hidden group"
          >
            <div className="relative z-10 w-2/3">
              <div className="bg-violet-100 text-violet-600 p-3 rounded-xl inline-block mb-4">
                <BrainCircuit className="w-6 h-6" />
              </div>
              <h3 className="text-2xl font-bold text-landing-text mb-3">Fake Review Detection</h3>
          ...
          >
             <div className="bg-fuchsia-100 text-fuchsia-600 p-3 rounded-xl inline-block mb-4">
              ...
              <h3 className="text-xl font-bold text-landing-text mb-3">Sentiment Analysis</h3>
