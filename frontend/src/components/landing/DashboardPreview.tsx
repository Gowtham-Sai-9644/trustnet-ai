    ...
    <section className="py-24 px-6 md:px-12 bg-landing-card border border-landing-border backdrop-blur-md">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <motion.h2  className="text-3xl md:text-5xl font-bold text-landing-text tracking-tight mb-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-transparent border border-landing-border rounded-3xl p-8 h-80 flex flex-col justify-between shadow-[0_4px_20px_rgb(0,0,0,0.03)]">
             <div>
                <h3 className="font-bold text-landing-text mb-1">Fake vs Genuine</h3>
                <p className="text-sm text-landing-muted opacity-70">Last 30 Days</p>
             </div>
          ...
          <div className="bg-transparent border border-landing-border rounded-3xl p-8 h-80 flex flex-col justify-between shadow-[0_4px_20px_rgb(0,0,0,0.03)]">
             <div>
                <h3 className="font-bold text-landing-text mb-1">Trust Score Distribution</h3>
                <p className="text-sm text-landing-muted opacity-70">Across 1M+ Products</p>
             </div>
